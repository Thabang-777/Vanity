      ...
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
          ...
          <form className='flex'>
            ...
            type='email' />
            <button type='submit' className='bg-white text-black px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all font-bold '>
              Subscribe
            </button>
          </form>
        </div>
        ...
        <div>
          <h3 className='text-lg text-gray-400 mb-4'>Follow us</h3>
